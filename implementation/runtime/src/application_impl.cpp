...
bool application_impl::init() {
    ...
    if (its_configuration) 
    {
        ...
        std::cout << "client_id," << client_ << std::endl;
        ...
        if (is_routing_manager_host_) 
        {
            ...
            {
                std::cout << "client_ == VSOMEIP_CLIENT_UNSET" << std::endl;
        ...
        //std::cout << "set_client" << client_ << std::endl;
        ...
        client_t _client, bool _force) const 
{
    ...
    // }
    //std::cout << "application_impl notify_one" << std::endl;
    if (routing_) 
    {
        //std::cout << "routing_ != NULL" << std::endl;   
    ...
    //std::cout << "application_impl::notify_one time," << (t2 - t1) * millisecond_coefficient << " ms" << std::endl;
}
